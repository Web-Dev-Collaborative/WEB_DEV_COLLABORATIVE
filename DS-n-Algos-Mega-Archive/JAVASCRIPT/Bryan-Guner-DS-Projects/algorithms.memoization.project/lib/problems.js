...
// values and a target amount as arguments. The method should return the minimum
// number of coins needed to make the target amount. A coin value can be used
// multiple times.
//
...
function minChange (coins, amount, memo = {}) {
  ...
  for (let i = coins.length - 1; i >= 0; i--) {
    ...
    if (currentCoin <= amount) {
      const newAmount = amount - currentCoin
      numCoins.push(1 + minChange(coins, newAmount, memo))
    }
  }
