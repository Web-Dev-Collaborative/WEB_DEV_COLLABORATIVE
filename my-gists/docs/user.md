...
## [](https://pandoc.org/MANUAL.html#headings-and-sections)Headings and sections
...
## [](https://pandoc.org/MANUAL.html#other-extensions)Other extensions

#### [](https://pandoc.org/MANUAL.html#extension-empty_paragraphs)Extension: `empty_paragraphs`
...
#### [](https://pandoc.org/MANUAL.html#extension-native_numbering)Extension: `native_numbering`
...
#### [](https://pandoc.org/MANUAL.html#extension-xrefs_name)Extension: `xrefs_name`
...
#### [](https://pandoc.org/MANUAL.html#extension-xrefs_number)Extension: `xrefs_number`
...
#### [](https://pandoc.org/MANUAL.html#ext-styles)Extension: `styles`
...
#### [](https://pandoc.org/MANUAL.html#extension-amuse)Extension: `amuse`

In the `muse` input format, this enables Text::Amuse extensions to Emacs Muse markup.

#### [](https://pandoc.org/MANUAL.html#extension-raw_markdown)Extension: `raw_markdown`
...
#### [](https://pandoc.org/MANUAL.html#org-citations)Extension: `citations`

Some aspects of [Pandoc's Markdown citation syntax](https://pandoc.org/MANUAL.html#citations) are also accepted in `org` input.

#### [](https://pandoc.org/MANUAL.html#extension-element_citations)Extension: `element_citations`
...
#### [](https://pandoc.org/MANUAL.html#extension-ntb)Extension: `ntb`
...
# [](https://pandoc.org/MANUAL.html#pandocs-markdown)Pandoc's Markdown
...
## [](https://pandoc.org/MANUAL.html#philosophy)Philosophy
...
## [](https://pandoc.org/MANUAL.html#paragraphs)Paragraphs
...
#### [](https://pandoc.org/MANUAL.html#extension-escaped_line_breaks)Extension: `escaped_line_breaks`
...
## [](https://pandoc.org/MANUAL.html#headings)Headings

There are two kinds of headings: Setext and ATX.

### [](https://pandoc.org/MANUAL.html#setext-style-headings)Setext-style headings
...
### [](https://pandoc.org/MANUAL.html#atx-style-headings)ATX-style headings
...
#### [](https://pandoc.org/MANUAL.html#extension-blank_before_header)Extension: `blank_before_header`
...
#### [](https://pandoc.org/MANUAL.html#extension-space_in_atx_header)Extension: `space_in_atx_header`
...
### [](https://pandoc.org/MANUAL.html#heading-identifiers)Heading identifiers

See also the [`auto_identifiers` extension](https://pandoc.org/MANUAL.html#extension-auto_identifiers) above.

#### [](https://pandoc.org/MANUAL.html#extension-header_attributes)Extension: `header_attributes`
...
#### [](https://pandoc.org/MANUAL.html#extension-implicit_header_references)Extension: `implicit_header_references`
...
## [](https://pandoc.org/MANUAL.html#block-quotations)Block quotations
...
#### [](https://pandoc.org/MANUAL.html#extension-blank_before_blockquote)Extension: `blank_before_blockquote`
...
## [](https://pandoc.org/MANUAL.html#verbatim-code-blocks)Verbatim (code) blocks

### [](https://pandoc.org/MANUAL.html#indented-code-blocks)Indented code blocks
...
### [](https://pandoc.org/MANUAL.html#fenced-code-blocks)Fenced code blocks

#### [](https://pandoc.org/MANUAL.html#extension-fenced_code_blocks)Extension: `fenced_code_blocks`
...
#### [](https://pandoc.org/MANUAL.html#extension-backtick_code_blocks)Extension: `backtick_code_blocks`

Same as `fenced_code_blocks`, but uses backticks (```) instead of tildes (`~`).

#### [](https://pandoc.org/MANUAL.html#extension-fenced_code_attributes)Extension: `fenced_code_attributes`
...
[](https://pandoc.org/MANUAL.html#line-blocks)Line blocks
---------------------------------------------------------

#### [](https://pandoc.org/MANUAL.html#extension-line_blocks)Extension: `line_blocks`
...
[](https://pandoc.org/MANUAL.html#lists)Lists
---------------------------------------------

### [](https://pandoc.org/MANUAL.html#bullet-lists)Bullet lists
...
### [](https://pandoc.org/MANUAL.html#block-content-in-list-items)Block content in list items
...
### [](https://pandoc.org/MANUAL.html#ordered-lists)Ordered lists
...
#### [](https://pandoc.org/MANUAL.html#extension-fancy_lists)Extension: `fancy_lists`
...
#### [](https://pandoc.org/MANUAL.html#extension-startnum)Extension: `startnum`
...
#### [](https://pandoc.org/MANUAL.html#extension-task_lists)Extension: `task_lists`
...
### [](https://pandoc.org/MANUAL.html#definition-lists)Definition lists

#### [](https://pandoc.org/MANUAL.html#extension-definition_lists)Extension: `definition_lists`
...
### [](https://pandoc.org/MANUAL.html#numbered-example-lists)Numbered example lists

#### [](https://pandoc.org/MANUAL.html#extension-example_lists)Extension: `example_lists`
...
### [](https://pandoc.org/MANUAL.html#ending-a-list)Ending a list
...
[](https://pandoc.org/MANUAL.html#horizontal-rules)Horizontal rules
-------------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#tables)Tables
-----------------------------------------------
...
#### [](https://pandoc.org/MANUAL.html#extension-table_captions)Extension: `table_captions`
...
#### [](https://pandoc.org/MANUAL.html#extension-simple_tables)Extension: `simple_tables`
...
#### [](https://pandoc.org/MANUAL.html#extension-multiline_tables)Extension: `multiline_tables`
...
#### [](https://pandoc.org/MANUAL.html#extension-grid_tables)Extension: `grid_tables`
...
##### [](https://pandoc.org/MANUAL.html#grid-table-limitations)Grid Table Limitations
...
#### [](https://pandoc.org/MANUAL.html#extension-pipe_tables)Extension: `pipe_tables`
...
[](https://pandoc.org/MANUAL.html#metadata-blocks)Metadata blocks
-----------------------------------------------------------------

#### [](https://pandoc.org/MANUAL.html#extension-pandoc_title_block)Extension: `pandoc_title_block`
...
#### [](https://pandoc.org/MANUAL.html#extension-yaml_metadata_block)Extension: `yaml_metadata_block`
...
[](https://pandoc.org/MANUAL.html#backslash-escapes)Backslash escapes
---------------------------------------------------------------------

#### [](https://pandoc.org/MANUAL.html#extension-all_symbols_escapable)Extension: `all_symbols_escapable`
...
[](https://pandoc.org/MANUAL.html#inline-formatting)Inline formatting
---------------------------------------------------------------------

### [](https://pandoc.org/MANUAL.html#emphasis)Emphasis
...
#### [](https://pandoc.org/MANUAL.html#extension-intraword_underscores)Extension: `intraword_underscores`
...
### [](https://pandoc.org/MANUAL.html#strikeout)Strikeout

#### [](https://pandoc.org/MANUAL.html#extension-strikeout)Extension: `strikeout`
...
### [](https://pandoc.org/MANUAL.html#superscripts-and-subscripts)Superscripts and subscripts

#### [](https://pandoc.org/MANUAL.html#extension-superscript-subscript)Extension: `superscript`, `subscript`
...
### [](https://pandoc.org/MANUAL.html#verbatim)Verbatim
...
#### [](https://pandoc.org/MANUAL.html#extension-inline_code_attributes)Extension: `inline_code_attributes`
...
### [](https://pandoc.org/MANUAL.html#underline)Underline
...
### [](https://pandoc.org/MANUAL.html#small-caps)Small caps
...
[](https://pandoc.org/MANUAL.html#math)Math
-------------------------------------------

#### [](https://pandoc.org/MANUAL.html#extension-tex_math_dollars)Extension: `tex_math_dollars`
...
[](https://pandoc.org/MANUAL.html#raw-html)Raw HTML
---------------------------------------------------

#### [](https://pandoc.org/MANUAL.html#extension-raw_html)Extension: `raw_html`
...
#### [](https://pandoc.org/MANUAL.html#extension-markdown_in_html_blocks)Extension: `markdown_in_html_blocks`
...
#### [](https://pandoc.org/MANUAL.html#extension-native_divs)Extension: `native_divs`
...
#### [](https://pandoc.org/MANUAL.html#extension-native_spans)Extension: `native_spans`
...
#### [](https://pandoc.org/MANUAL.html#extension-raw_tex)Extension: `raw_tex`
...
### [](https://pandoc.org/MANUAL.html#generic-raw-attribute)Generic raw attribute

#### [](https://pandoc.org/MANUAL.html#extension-raw_attribute)Extension: `raw_attribute`
...
[](https://pandoc.org/MANUAL.html#latex-macros)LaTeX macros
-----------------------------------------------------------

#### [](https://pandoc.org/MANUAL.html#extension-latex_macros)Extension: `latex_macros`
...
[](https://pandoc.org/MANUAL.html#links-1)Links
-----------------------------------------------

Markdown allows links to be specified in several ways.

### [](https://pandoc.org/MANUAL.html#automatic-links)Automatic links
...
### [](https://pandoc.org/MANUAL.html#inline-links)Inline links
...
### [](https://pandoc.org/MANUAL.html#reference-links)Reference links
...
#### [](https://pandoc.org/MANUAL.html#extension-shortcut_reference_links)Extension: `shortcut_reference_links`
...
### [](https://pandoc.org/MANUAL.html#internal-links)Internal links
...
[](https://pandoc.org/MANUAL.html#images)Images
-----------------------------------------------
...
#### [](https://pandoc.org/MANUAL.html#extension-implicit_figures)Extension: `implicit_figures`
...
#### [](https://pandoc.org/MANUAL.html#extension-link_attributes)Extension: `link_attributes`
...
[](https://pandoc.org/MANUAL.html#divs-and-spans)Divs and Spans
---------------------------------------------------------------
...
#### [](https://pandoc.org/MANUAL.html#extension-fenced_divs)Extension: `fenced_divs`
...
#### [](https://pandoc.org/MANUAL.html#extension-bracketed_spans)Extension: `bracketed_spans`
...
[](https://pandoc.org/MANUAL.html#footnotes)Footnotes
-----------------------------------------------------

#### [](https://pandoc.org/MANUAL.html#extension-footnotes)Extension: `footnotes`
...
#### [](https://pandoc.org/MANUAL.html#extension-inline_notes)Extension: `inline_notes`
...
[](https://pandoc.org/MANUAL.html#citation-syntax)Citation syntax
-----------------------------------------------------------------

#### [](https://pandoc.org/MANUAL.html#extension-citations)Extension: `citations`
...
[](https://pandoc.org/MANUAL.html#non-default-extensions)Non-default extensions
-------------------------------------------------------------------------------
...
#### [](https://pandoc.org/MANUAL.html#extension-rebase_relative_paths)Extension: `rebase_relative_paths`
...
#### [](https://pandoc.org/MANUAL.html#extension-attributes)Extension: `attributes`

Allows attributes to be attached to any inline or block-level element. The syntax for the attributes is the same as that used in [`header_attributes`](https://pandoc.org/MANUAL.html#extension-header_attributes).
...
#### [](https://pandoc.org/MANUAL.html#extension-old_dashes)Extension: `old_dashes`
...
#### [](https://pandoc.org/MANUAL.html#extension-angle_brackets_escapable)Extension: `angle_brackets_escapable`
...
#### [](https://pandoc.org/MANUAL.html#extension-lists_without_preceding_blankline)Extension: `lists_without_preceding_blankline`

Allow a list to occur right after a paragraph, with no intervening blank space.

#### [](https://pandoc.org/MANUAL.html#extension-four_space_rule)Extension: `four_space_rule`
...
#### [](https://pandoc.org/MANUAL.html#extension-spaced_reference_links)Extension: `spaced_reference_links`
...
#### [](https://pandoc.org/MANUAL.html#extension-hard_line_breaks)Extension: `hard_line_breaks`

Causes all newlines within a paragraph to be interpreted as hard line breaks instead of spaces.

#### [](https://pandoc.org/MANUAL.html#extension-ignore_line_breaks)Extension: `ignore_line_breaks`
...
#### [](https://pandoc.org/MANUAL.html#extension-east_asian_line_breaks)Extension: `east_asian_line_breaks`
...
#### [](https://pandoc.org/MANUAL.html#extension-emoji)Extension: `emoji`

Parses textual emojis like `:smile:` as Unicode emoticons.

#### [](https://pandoc.org/MANUAL.html#extension-tex_math_single_backslash)Extension: `tex_math_single_backslash`
...
#### [](https://pandoc.org/MANUAL.html#extension-tex_math_double_backslash)Extension: `tex_math_double_backslash`
...
#### [](https://pandoc.org/MANUAL.html#extension-markdown_attribute)Extension: `markdown_attribute`
...
#### [](https://pandoc.org/MANUAL.html#extension-mmd_title_block)Extension: `mmd_title_block`
...
#### [](https://pandoc.org/MANUAL.html#extension-abbreviations)Extension: `abbreviations`
...
#### [](https://pandoc.org/MANUAL.html#extension-autolink_bare_uris)Extension: `autolink_bare_uris`

Makes all absolute URIs into links, even when not surrounded by pointy braces `<...>`.

#### [](https://pandoc.org/MANUAL.html#extension-mmd_link_attributes)Extension: `mmd_link_attributes`
...
#### [](https://pandoc.org/MANUAL.html#extension-mmd_header_identifiers)Extension: `mmd_header_identifiers`
...
#### [](https://pandoc.org/MANUAL.html#extension-compact_definition_lists)Extension: `compact_definition_lists`
...
#### [](https://pandoc.org/MANUAL.html#extension-gutenberg)Extension: `gutenberg`
...
#### [](https://pandoc.org/MANUAL.html#extension-sourcepos)Extension: `sourcepos`

Include source position attributes when parsing `commonmark`. For elements that accept attributes, a `data-pos` attribute is added; other elements are placed in a surrounding Div or Span elemnet with a `data-pos` attribute.

#### [](https://pandoc.org/MANUAL.html#extension-short_subsuperscript)Extension: `short_subsuperscript`
...
[](https://pandoc.org/MANUAL.html#markdown-variants)Markdown variants
---------------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#citations)Citations
=====================================================
...
[](https://pandoc.org/MANUAL.html#specifying-bibliographic-data)Specifying bibliographic data
---------------------------------------------------------------------------------------------
...
### [](https://pandoc.org/MANUAL.html#capitalization-in-titles)Capitalization in titles
...
### [](https://pandoc.org/MANUAL.html#conference-papers-published-vs.-unpublished)Conference Papers, Published vs. Unpublished
...
[](https://pandoc.org/MANUAL.html#specifying-a-citation-style)Specifying a citation style
-----------------------------------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#citations-in-note-styles)Citations in note styles
-----------------------------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#raw-content-in-a-style)Raw content in a style
-------------------------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#including-uncited-items-in-the-bibliography)Including uncited items in the bibliography
-------------------------------------------------------------------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#other-relevant-metadata-fields)Other relevant metadata fields
-----------------------------------------------------------------------------------------------
...
If true (the default), pandoc will put footnote citations after following punctuation. For example, if the source contains `blah blah [@jones99].`, the result will look like `blah blah.[^1]`, with the note moved after the period and the space collapsed. If false, the space will still be collapsed, but the footnote will not be moved after the punctuation.

[](https://pandoc.org/MANUAL.html#slide-shows)Slide shows
=========================================================
...
[](https://pandoc.org/MANUAL.html#structuring-the-slide-show)Structuring the slide show
---------------------------------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#incremental-lists)Incremental lists
---------------------------------------------------------------------
...
Note: Neither the [`-i/--incremental`](https://pandoc.org/MANUAL.html#option--incremental) option nor any of the methods described here currently works for PowerPoint output.

[](https://pandoc.org/MANUAL.html#inserting-pauses)Inserting pauses
-------------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#styling-the-slides)Styling the slides
-----------------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#speaker-notes)Speaker notes
-------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#columns)Columns
-------------------------------------------------
...
### [](https://pandoc.org/MANUAL.html#additional-columns-attributes-in-beamer)Additional columns attributes in beamer
...
[](https://pandoc.org/MANUAL.html#frame-attributes-in-beamer)Frame attributes in beamer
---------------------------------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#background-in-reveal.js-and-beamer)Background in reveal.js and beamer
-------------------------------------------------------------------------------------------------------
...
[](https://pandoc.org/MANUAL.html#epubs)EPUBs
=============================================
...
[](https://pandoc.org/MANUAL.html#the-epubtype-attribute)The `epub:type` attribute
----------------------------------------------------------------------------------
...
## [](https://pandoc.org/MANUAL.html#linked-media)Linked media
...
# [](https://pandoc.org/MANUAL.html#jupyter-notebooks)Jupyter notebooks
...
[](https://pandoc.org/MANUAL.html#syntax-highlighting)Syntax highlighting
=========================================================================
...
[](https://pandoc.org/MANUAL.html#custom-styles)Custom Styles
=============================================================

Custom styles can be used in the docx and ICML formats.

[](https://pandoc.org/MANUAL.html#output)Output
-----------------------------------------------
...
[](https://pandoc.org/MANUAL.html#input)Input
---------------------------------------------
...
[](https://pandoc.org/MANUAL.html#custom-writers)Custom writers
===============================================================

Pandoc can be extended with custom writers written in [Lua](https://www.lua.org/). (Pandoc includes a Lua interpreter, so Lua need not be installed separately.)
...
[](https://pandoc.org/MANUAL.html#reproducible-builds)Reproducible builds
=========================================================================
...
[](https://pandoc.org/MANUAL.html#a-note-on-security)A note on security
=======================================================================
...
2.  Several input formats (including HTML, Org, and RST) support `include` directives that allow the contents of a file to be included in the output. An untrusted attacker could use these to view the contents of files on the file system.
...
4.  Pandoc's parsers can exhibit pathological performance on some corner cases. It is wise to put any pandoc operations under a timeout, to avoid DOS attacks that exploit these issues. If you are using the pandoc executable, you can add the command line options `+RTS -M512M -RTS` (for example) to limit the heap size to 512MB.

5.  The HTML generated by pandoc is not guaranteed to be safe. If `raw_html` is enabled for the Markdown input, users can inject arbitrary HTML. Even if `raw_html` is disabled, users can include dangerous content in URLs and attributes. To be safe, you should run all the generated HTML through an HTML sanitizer.

[](https://pandoc.org/MANUAL.html#authors)Authors
=================================================
