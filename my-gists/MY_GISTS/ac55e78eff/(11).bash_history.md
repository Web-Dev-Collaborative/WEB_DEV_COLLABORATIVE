...
pandoc _.md> -o \_OUTPUT.html
pandoc _.md> -o \_OUTPUT.html
pandoc.exe: ~/. _.md>-o OUTPUT.html
pandoc ~/. _.md>-o OUTPUT.html
pandoc _.md>-o OUTPUT.html
find ./ -iname "_.md" -type f -exec sh -c 'pandoc _.md> -o ./OUTPUT.html'
pandoc _.md> -o ./OUTPUT.html
git clone https://github.com/bgoonz/web-dev-notes-resource-site.git
rm -rf .git
rm -rf _.git
...
git push -u origin master
git push
cd "c:\MY-WEB-DEV\08-my-website_Outer-STABLE\Stable\2-content\Data-Structures\DS-ALGO-OFFICIAL\CONTAINER\DS-n-Algos\Recursion\My-Recursion-Prac-Website\Recur-website"
git commit -f
git pull
git init
git add .
