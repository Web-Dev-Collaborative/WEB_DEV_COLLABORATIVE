...
recursive_for_loop
function recursive_for_loop { for f in ./; do if [ -d $f -a ! -h $f ]; then cd -- "$f"; find ./ -type d -exec echo "</body></html>" | tee -a _.html {} \;; recursive_for_loop; cd ..; fi; done; };
recursive_for_loop
find ./ -type d -execdir echo "</body></html>" | tee -a _.html {} \;
