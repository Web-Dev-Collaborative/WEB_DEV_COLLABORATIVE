...
window.PARSELY = window.PARSELY || {}, (() => {
  ...
  "function" != typeof JSON.stringify &&
    ...
    "function" != typeof JSON.parse &&
      (JSON.parse = (() => {
      function e(e) {
        return e.replace(/\\(?:u(.{4})|([^u]))/g, (e, t, n) => {
  ...
  var c = [];
  const l = c.slice;
  const f = (c.concat, c.push);
  const d = (c.indexOf, {});
  const p = d.toString;
  const g = d.hasOwnProperty;
  const h = {};
  ...
  var v = function D(e, t) {
    return new D.fn.init(e, t);
  };

  const m = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;
  const _ = /^-ms-/;
  const S = /-([\da-z])/gi;
  ...
  (v.fn = v.prototype = {
    ...
    pushStack: function (e) {
      const t = v.merge(this.constructor(), e);
  ...
  let P;
  const A = /\S+/g;
  const R = "undefined" == typeof undefined ? "undefined" : _typeof(undefined);
  for (P in v(h)) break;
  (h.ownLast = "0" !== P),
    (v.acceptData = e => {
      const t = v.noData[(e.nodeName + " ").toLowerCase()], n = +e.nodeType || 1;
      return (
        (1 === n || 9 === n) &&
  ...
  const L = /^key/, C = /^(?:mouse|pointer|contextmenu)|click/, T = /^(?:focusinfocus|focusoutblur)$/, O = /^([^.]*)(?:\.(.+)|)$/;
  (v.event = {
    global: {},
          ...
          n.handler && ((n = (u = n).handler), (o = u.selector)),
            ...
            (l = y.handle) ||
              ((l = y.handle = function (e) {
                return _typeof(v) === R || (e && v.event.triggered === e.type)
                  ? undefined
    ...
    trigger: function (t, n, i, o) {
      ...
      let f;
      const d = [i || w];
      let p = g.call(t, "type") ? t.type : t;
      let h = g.call(t, "namespace") ? t.namespace.split(".") : [];
      if (
        ((s = l = i = i || w),
        3 !== i.nodeType &&
          8 !== i.nodeType &&
    ...
    dispatch: function (e) {
      ...
      let r;
      let a = [];
      const s = l.call(arguments);
      const u = (v._data(this, "events") || {})[e.type] || [];
      const c = v.event.special[e.type] || {};
      if (
        ((s[0] = e),
  ...
  const j = e.jQuery, I = e.$;
  return (v.noConflict = t => {
    return e.$ === v && (e.$ = I), t && e.jQuery === v && (e.jQuery = j), v;
  }),
  _typeof(t) === R && (e.jQuery = e.$ = v),
  v
;
}), "undefined" == typeof window.PARSELY && (window.PARSELY = {}), ((e, t) => {
  ...
  const a = (() => {
    ...
    return i(e, [
      ...
      },
      {
        ...
        value: function (e, t) {
          const n = this._getRegistry(e), i = n.indexOf(t);
          i > -1 && n.splice(i, 1);
        },
      },
      {
        ...
        value: function (e) {
          ...
          Object.freeze(e),
          this._getRegistry(e.type).forEach(t => {
            return t(e);
          }),
          !0
        ;
  ...
  return new ((e => {
    function t() {
      n(this, t);
      const e = r(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this)), i = _();
      return (e._state = i),
      (e._unsavedChanges = []),
      ...
      h &&
        addEventListener("beforeunload", t => {
          e._safariBeforeUnloadTimeout = setTimeout(() => {
            t.defaultPrevented ||
    ...
    i(t, [
      ...
      },
      {
        ...
        value: function (e) {
          const t = this._unsavedChanges.indexOf(e);
          t > -1 &&
  ...
  (t.util = {}),
    ...
    (e.windowSetFunction = (t, n) => {
      const i = e.getWindow(), o = i[t];
      i[t] = () => {
        n(), "function" == typeof o && o();
      };
    }),
    (e.windowAddEventListener = (e, t) => {
      let n = !1;
      try {
        addEventListener(
          "test",
  ...
  "use strict";
  e.Cookies = (t => {
    const n = function i(e, t, n) {
      return 1 === arguments.length ? i.get(e) : i.set(e, t, n);
    };
    return (n._document = t.document),
    ...
    (n.expire = (e, t) => {
      ...
      for (let i = 0; i < e.length; i++) n.set(e[i], undefined, t);
    }),
    (n._getExtendedOptions = e => {
      return {
    ...
    (n._generateCookieString = (t, i, o) => {
      ...
      const r = (o = o || {}).domain || e.cookieDomain || n._autoCookieDomain;
      let a = t + "=" + i;
      return (
    ...
    (n._getCacheFromString = e => {
      for (
        var t = {}, i = e ? e.split("; ") : [], o = 0;
        o < i.length;
        o++
      ) {
        const r = n._getKeyValuePairFromCookieString(i[o]);
        if (null != r) {
          const a = n._cacheKeyPrefix + r.key;
          t[a] === undefined && (t[a] = r.value);
        }
      }
      return t;
    }),
    (n._getKeyValuePairFromCookieString = e => {
      let t = e.indexOf("=");
      t = t < 0 ? e.length : t;
      let n = e.substr(0, t), i = e.substr(t + 1);
      try {
    ...
    (n._isValidDomain = e => {
      const t = "cookies.js_dtest", i = "1" === n.set(t, 1, { domain: e }).get(t);
      return n.expire(t, { domain: e }), i;
    }),
    (n._getAutoCookieDomain = () => {
      const t = e.util.getWindow().location.hostname;
      if (!isNaN(parseInt(t.replace(".", ""), 10)))
        return n._isValidDomain(t) ? t : null;
      const i = t.split(".");
      if (1 === i.length) return t;
      for (var o, r = 2; r <= i.length; r++) {
        const a = i.slice(-r).join(".");
  ...
  t.prototype = (() => {
    ...
    (t._deserialize = e => {
      const n = e.split(t._delimiter), i = { value: n[0] };
      return n.length > 1 && (i.expires = n[1]), i;
    }),
    (t._migrateCookie = n => {
      const i = e.Cookies.get(n);
      if ((e.Cookies.expire(n), void 0 !== i)) {
        const o = e.ParselyStorage.defaults[n], r = {};
    ...
    const n = new t(),
          i =
            (() => {
              ...
              let t = !1;
              const n = e.Cookies.get("_parsely_visitor");
              return (
  ...
  const e = this.PARSELY,
        ...
        a = t.extend({
          ...
          getVisitorInfo: function (t) {
            t = t || !1;
            let r = n.get(this.visitorCookieName);
            if (void 0 === r) {
              let a = n.get(this.legacyVisitorCookieName);
              const s = e.config.apikey_uuid || e.config.uuid;
  ...
  const e = this.PARSELY,
        ...
        a = n.extend({
          ...
          getSession: function (n) {
            n = n || !1;
            const a = r.getVisitorInfo();
            let s = i.getJSON(this.sessionCookieName);
            if (void 0 === s) {
              let u, c;
              !1 === a
                ? ((u = 1), (c = 0))
  ...
  const e = this.PARSELY, t = e.util, n = e.JSON, i = e.$, o = t.getWindow().document;
  (PARSELY.getLdJsonMetas = () => {
    for (let e = o.getElementsByTagName("script"), t = 0; t < e.length; t++) {
      const i = e[t];
    ...
    (PARSELY.getRepeatedMetaMetas = () => {
      for (
        ...
        const a = t[r], s = n[a.getAttribute("name")];
        if (void 0 !== s) {
          const u = a.getAttribute("content");
          "authors" === s
    ...
    (PARSELY.getParselyPageMetas = () => {
      for (let e = o.getElementsByTagName("meta"), t = 0; t < e.length; t++) {
        const i = e[t];
        if ("parsely-page" === i.getAttribute("name")) {
          const r = i.getAttribute("value") || i.getAttribute("content");
          try {
            return n.parse(r);
          } catch (a) {
            return null;
  ...
  var r = this.PARSELY;
  const a = r.util;
  const s = r.ParselyStorage;
  var u = "data-parsely-slot";
  if (((r.slots = r.slots || {}), document.querySelector)) {
    ...
    var c = 1;
    a.objAddEventListener(document.body, "click", a => {
      const u = i(a.target ? a.target : a.srcElement);
      if (null === u) return !0;
  ...
  e.Sampler = (n => {
    ...
    (i._setHeartbeatTimeout = e => {
      const t = i._accumulators[e];
      "undefined" != typeof t.heartbeatTimer && i._unsetHeartbeatTimeout(e);
      const o = Math.random() * i._jitterRange + i._jitterFloor, r = t.heartbeatInterval + o;
      t.heartbeatTimer = n.setTimeout(() => {
        i.sendHeartbeat(e);
      }, r);
    }),
    (i._unsetHeartbeatTimeout = e => {
      const t = i._accumulators[e];
    ...
    (i._sample = (t, n) => {
      ...
      let o, r, a, s;
      for (const u in i._accumulators)
        (o = i._accumulators[u]),
    ...
    (i.sendHeartbeat = (e, t, n, o) => {
      const r = i._accumulators[e];
      if (void 0 !== r) {
        const a = void 0 === t ? r.ms / 1e3 : t, s = Math.round(a);
    ...
    (i._sendHeartbeats = (e, t) => {
      for (const n in i._accumulators) i.sendHeartbeat(n, e, t, !0);
    }),
    (i._setUnloadListeners = () => {
      e._lifecycle.addEventListener("statechange", e => {
  ...
  const e = this.PARSELY, t = e.config.settings, n = e.Sampler, i = e.$, o = e.util;
  if ("boolean" != typeof e.enableHeartbeats || e.enableHeartbeats) {
    ...
    (e.engagedTime = e.engagedTime || {}),
      ...
      !0 !== e.fbInstantArticles &&
        e._lifecycle.addEventListener("statechange", t => {
          const n = t.newState.toLowerCase();
    ...
    !0 !== e.fbInstantArticles
      ...
      (e.engagedTime.sendHeartbeat = (t, n, r, a) => {
        (t = void 0 === t ? 0 : t),
      ...
      (e.engagedTime.startTracking = () => {
        const t = !0 === e.fbInstantArticles ? undefined : e.engagedTime.sample;
        n.trackKey(
      ...
      (e.engagedTime.stopTracking = () => {
        n.dropKey(e.ENGAGED_TIME_SAMPLER_KEY);
      }),
      (e.engagedTime.initNewPage = () => {
        e.engagedTime.stopTracking(), e.engagedTime.startTracking();
      }),
      e.engagedTime.startTracking();
  }
})(), (function () {
  const e = this.PARSELY, t = e.$, n = e.Class, i = e.JSON, o = e.console, r = e.config, a = e.urls, s = e.visitorManager, u = e.sessionManager, c = e.ParselyStorage, l = e.util.getWindow(), f = l.document, d = l.screen;
  PARSELY.Pixel = n.extend({
    init: function () {
      const t = e.util.getEventUrl(),
            n =
              d.width +
              "x" +
              d.height +
    ...
    isThirdPartyAnalyticsBlocked: function () {
      ...
      const t = this.thirdPartyBlockedCookieSettings, n = c.getJSON(t.name);
      if (
        (void 0 !== n &&
    ...
    saveVisitorID: function (e) {
      const t = u.getSession(), n = { id: e, session_count: t.sid, last_session_ts: t.sts };
    ...
    requestFetch: function (n, i) {
      return o.log("fetching endpoint: " + this.remoteEndpoint),
    ...
    generateEventCorrelationId: function (t, n) {
      const i = this.getCorrelationIdKey(t);
      return !0 === n && (e[i] = Math.floor(99999999 * Math.random())), e[i];
    },
    beacon: function (n, o, c) {
      const l = u.getSession(!0), f = e.util.now(), d = this.generatePageloadId() || 0, p = t.extend(!0, { rand: f, plid: d }, this.data, l, n), g = e.visitorManager.getVisitorInfo();
      !0 === this.isThirdPartyAnalyticsBlocked() &&
        ((p.tpab = 1), (p.data.flashlight = 1)),
        s.extendVisitorExpiry();
      let h;
      for (const y in this.correlationIds)
  ...
  const e = this.PARSELY, t = e.$, n = e.console, i = e.Class, o = e.JSON, r = e.ParselyStorage, a = e.util.getWindow().document;
  PARSELY.Beacon = i.extend({
    ...
    trackPageView: function (i, s) {
      ...
      const c = r.getJSON("_parsely_slot_click");
      c &&
    ...
    trackConversion: function (e) {
      ...
      const i = ["active", "lead", "customer"], o = { label: undefined };
      e && e.category
  ...
  const e = PARSELY.config.settings, t = PARSELY.console, n = PARSELY.$;
  (PARSELY.updateDefaults = e => {
    return PARSELY.beacon.pixel.addDefaults(e);
  }),
    (PARSELY.setConfigOptions = e => {
      e.hasOwnProperty("track_ip_addresses") &&
        (PARSELY.config.track_ip_addresses = e.track_ip_addresses);
    }),
    (PARSELY.initNewPage = e => {
  ...
  const e = PARSELY.onload, t = PARSELY.console;
