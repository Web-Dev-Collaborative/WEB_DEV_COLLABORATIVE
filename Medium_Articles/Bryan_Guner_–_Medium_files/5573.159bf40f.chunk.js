      ...
      t.exports = (t => {
        ...
        (t, e) => {
          ...
          Object.defineProperty(e, "__esModule", { value: !0 }),
            (e.default = (t, e) => {
              if (t) for (const n in t) hasOwnProperty.call(t, n) && e(t[n], n);
            }),
            (t.exports = e.default);
        },
        (t, e, n) => {
          ...
          const r = n(7),
                o = (() => {
                  ...
                  (t.prototype._context = () => {
                    return r.spanContext;
                  }),
                  (t.prototype._tracer = () => {
                    return r.tracer;
                  }),
                  (t.prototype._setOperationName = t => {}),
                  (t.prototype._setBaggageItem = (t, e) => {}),
                  (t.prototype._getBaggageItem = t => {}),
                  (t.prototype._addTags = t => {}),
                  (t.prototype._log = (t, e) => {}),
                  (t.prototype._finish = t => {}),
                  t
                ;
                })();
        ...
        (t, e) => {
          "use strict";
          Object.defineProperty(e, "__esModule", { value: !0 });
          const n = (e.LOG_INFO = 0), r = (e.LOG_WARN = 1), o = (e.LOG_ERROR = 2), i = (e.LOG_FATAL = 3);
        ...
        (t, e, n) => {
          ...
          const r = n(11),
                ...
                s = (() => {
                  ...
                  (t.prototype._startSpan = (t, e) => {
                    return o.span;
                  }),
                  (t.prototype._inject = (t, e, n) => {}),
                  (t.prototype._extract = (t, e) => {
        ...
        (t, e) => {
          ...
          (t.exports.parseScriptElementOptions = (t, e) => {
            ...
            (t.exports.parseURLQueryOptions = t => {
              if (window) {
                const e = (t => {
                  const e = {}, n = window.location.href.indexOf("?");
                  if (n < 0) return e;
                  let r = window.location.href.slice(n + 1);
                  r.indexOf("#") >= 0 && (r = r.slice(0, r.indexOf("#")));
                  for (
                    let o = r.replace(/\+/, "%20").split("&"), i = 0;
                    i < o.length;
                    i++
                  ) {
                    const s = o[i].split("=");
          ...
          const r = (() => {
                ...
                u = (() => {
                  if (
                    ...
                    const t = (() => {
                      const t = performance.timing.navigationStart;
                      return {
                        v() {
                  ...
                  return r(
                    ...
                    [
                      ...
                      },
                      {
                        key: "runtimeGUID",
                        value(t) {
                          const e = "lightstep_guid/" + t, n = i.cookie(e) || this._generateLongUUID();
                          i.cookie(e, n, a, "/");
                          const r = i.cookie(s) || this._generateLongUUID();
                ...
                c = (t => {
                  ...
                  return ((t, e) => {
                    ...
                    },
                    {
                      ...
                      value(t, e) {
                        ...
                        if ("object" == typeof t) {
                          ...
                          const s = new l.crouton_thrift.LogRecord({
                            timestamp_micros: r,
                            fields: o,
                          });
                    ...
                    },
                    {
                      ...
                      value() {
                        const t = [];
                        return (0, a.default)(this._tags, (e, n) => {
                          t.push(
                            new l.crouton_thrift.KeyValue({
                              Key: i.toString(n),
                              Value: i.toString(e),
          ...
          const w = (t => {
            function e(t) {
              ...
              (r._clockState = new p({
                ...
                localStoreGet() {
                  const t = "clock_state/" + r._options.collector_host;
                  return r._platform.localStoreGet(t);
                },
                localStoreSet(t) {
                  const e = "clock_state/" + r._options.collector_host;
            ...
            return ((t, e) => {
              ...
              },
              {
                ...
                value(t, e) {
                  ...
                  let r = null;
                  if ((e = e || {}).references)
                    for (let o = 0; o < e.references.length; o++) {
                      const i = e.references[o], s = i.type();
                      if (
                        s === this._opentracing.REFERENCE_CHILD_OF ||
                        s === this._opentracing.REFERENCE_FOLLOWS_FROM
                      ) {
                        const c = i.referencedContext();
                        if (!c) {
                          this._error(
              ...
              },
              {
                ...
                value(t, e) {
                  const n = this;
                  const r = new a.default(null, null);
                  let o = 0;
              ...
              },
              {
                key: "verbosity",
                value() {
                  const t = this._options.verbosity;
                  return void 0 === t ? 1 : t;
                },
              },
              {
                ...
                value() {
                  let t = this._platform.generateUUID();
                  return (
              ...
              },
              {
                ...
                value(t) {
                  const e = this._platform.options(this) || {};
                  (0, l.default)(t, (t, n) => {
                    e[n] = t;
                  }),
                    this.options(e);
                ...
                value(t) {
                  ...
                  if (null === this._thriftAuth)
                    this._options.access_token.length > 0 &&
                      ...
                      const t = {};
                      (0, l.default)(e._options.tags, (n, r) => {
                      ...
                      const n = e._platform.tracerTags();
                      (0, l.default)(n, (e, n) => {
                        t[n] = e;
                      });
                      const r = [];
              ...
              },
              {
                ...
                value(t) {
                  const e = this, n = this._platform.plugins(t);
                  (0, l.default)(n, t => {
                    e.addPlugin(t);
                  });
                },
              ...
              },
              {
                ...
                value() {
                  ...
                  (this._activeRootSpan = null),
                    (0, l.default)(this._activeRootSpanSet, e => {
                      (!t._activeRootSpan ||
              ...
              },
              {
                ...
                value() {
                  ...
                  const t = {};
                  (0, l.default)(this._counters, (e, n) => {
                    t[n] = 0;
                  }),
                    (this._counters = t);
                },
              },
              {
                ...
                value() {
                  ...
                  let t = !0;
                  return (0, l.default)(this._counters, e => {
                    e > 0 && (t = !1);
                  }),
                  t
                ;
              ...
              },
              {
                ...
                value() {
                  ...
                  if (this._options.disable_report_on_exit)
                    ...
                    let e = 0;
                    this._platform.onBeforeExit(() => {
                      e++ > 0 ||
                        (t._info("Final flush before exit."),
                        t._flushReport(!1, !0, e => {
                          e &&
              ...
              },
              {
                ...
                value(t) {
                  ...
                  if (!this._reportTimer) {
                    let n = this._options.max_reporting_interval_millis;
                    ...
                    this._debug("Delaying next flush for " + i + "ms"),
                      (this._reportTimer = g.detachedTimeout(() => {
              ...
              },
              {
                ...
                value(t, e, n) {
                  const r = this;
                  n = n || (t => {});
                  const o = this._clockState.isReady(), i = this._clockState.offsetMicros();
                  this._debug("time correction state", {
                    offset_micros: i,
                    active_samples: this._clockState.activeSampleCount(),
                    ready: o,
                  });
                  let s = this._spanRecords, a = this._counters, u = this._internalLogs;
                  ...
                  const _ = this._useClockState ? i : 0,
                  ...
                  const v = this._platform.nowMicros();
                  this._transport.report(
                    e,
                    this._thriftAuth,
                    h,
                    (t, o) => {
                      const i = r._platform.nowMicros(), s = (d - h.oldest_micros) / 1e6;
                      if (t) {
                ...
                i = (() => {
                  ...
                  return r(t, [
                    ...
                    },
                    {
                      key: "update",
                      value() {
                        let t = Number.MAX_VALUE, e = 0;
                        if (
                          ((0, o.default)(this._samples, n => {
                            n.delayMicros < t &&
                      ...
                      value(t, e) {
                        ...
                        if (t) {
                          if (
                            ...
                            (0, o.default)(e, (e, r) => {
                              if ("number" == typeof e && 0 !== e) {
                                ...
                                "navigationStart" === r &&
                                  ...
                                  (o = {
                                    navigator: n._copyNavigatorProperties(
                                      navigator
                                    ),
                                  }),
                                  t.log(
                            ...
                            const r = window.chrome.loadTimes();
                            r &&
                              t.log(
                                {
        ...
        (t, e, n) => {
          ...
          function r() {
            ...
            for (
              ...
              const o = t[r].split("=", 2);
              if (2 === o.length) {
                const i = o[0].replace(/^\s+/, "").replace(/\s+$/, "");
          ...
          const l = (() => {
            ...
            return i(t, [
              ...
              },
              {
                ...
                value() {
                  if (this._enabled) {
                    const t = u.XMLHttpRequest.prototype;
              ...
              },
              {
                ...
                value(t, e) {
                  if (
                    ...
                    this._proxyInited = !0;
                    const n = u.XMLHttpRequest.prototype;
              ...
              },
              {
                ...
                value(t) {
                  ...
                  if (0 !== t.collector_host.length) {
                    const n = e(t.collector_host), r = e(t.collector_port), o = [new RegExp("^https?://" + n + ":" + r)];
                    "80" === r
              ...
              },
              {
                ...
                value() {
                  ...
                  return function (n, i, a, l, c) {
                    ...
                    const h = u.open.apply(this, arguments);
              ...
              },
              {
                ...
                value() {
                  ...
                  return function () {
                    ...
                    const r = this.__tracer_span;
                    if (!r) return u.send.apply(this, arguments);
                    let o = Array.prototype.slice.call(arguments), i = void 0;
                    if (1 === o.length) {
                    ...
                    const s = void 0 === i ? "" : ", data length=" + i;
                    r.log({ event: "send", data_length: s });
                    const l = {};
                    return e.inject(r.context(), a.FORMAT_HTTP_HEADERS, l),
              ...
              },
              {
                ...
                value(t, e, n) {
                  ...
                  if (!n) return !1;
                  for (const o in this._internalExclusions)
                    if (
                      ...
                      return !1;
                  let i = !1;
                  for (const s in r.xhr_url_inclusion_patterns)
                    if (
                  ...
                  if (!i) return !1;
                  for (const a in r.xhr_url_exclusion_patterns)
                    if (
                ...
                i = (() => {
                  ...
                  return r(t, [
                    ...
                    },
                    {
                      key: "_handleLogAdded",
                      value(t) {
                        const e = o.LOG_STRING_TO_LEVEL[t.level], n = t.message;
                        if (n) {
                          let r = t.payload_json;
                          if (r)
                            try {
                              r = JSON.parse(r);
                            } catch (t) {}
        ...
        (t, e, n) => {
          ...
          function o() {}
          const i = "function" != typeof Object.create && "~";
          (o.prototype._events = void 0),
            (o.prototype.listeners = function (t, e) {
              const n = i ? i + t : t, r = this._events && this._events[n];
              if (e) return !!r;
              if (!r) return [];
              if (r.fn) return [r.fn];
            ...
            (o.prototype.on = function (t, e, n) {
              const o = new r(e, n || this), s = i ? i + t : t;
              return (
            ...
            (o.prototype.once = function (t, e, n) {
              const o = new r(e, n || this, !0), s = i ? i + t : t;
              return (
                this._events || (this._events = i ? {} : Object.create(null)),
                this._events[s]
                  ? this._events[s].fn
