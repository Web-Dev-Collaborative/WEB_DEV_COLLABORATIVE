...
( function ( I, ea ) {
  ...
  function hj( a, b, c ) {
    ...
    switch ( b.tag ) {
      ...
      case 13:
        ...
        if ( c && !d && 0 !== ( b.mode & 2 ) )
          if ( null === a && !0 !== b.memoizedProps.unstable_avoidThisFallback || 0 !== ( D.current & 1 ) ) F === Xa && ( F = ad );
          else {
            if ( F === Xa || F === ad ) F = bd;
  ...
  var zj = function ( a, b, c ) {
    ...
    switch ( b.tag ) {
      ...
      case 16:
        a: {
          e = b.elementType;null !== a && ( a.alternate = null, b.alternate = null, b.effectTag |= 2 );a = b.pendingProps;ri( e );
