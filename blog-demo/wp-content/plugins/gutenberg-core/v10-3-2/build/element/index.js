window.wp = window.wp || {}, window.wp.element = function ( e ) {
  var t = {};
      ...
      return Object( n.a )( e ) || function ( e, t ) {
        if ( "undefined" != typeof Symbol && Symbol.iterator in Object( e ) ) {
          var r = [],
            ...
            o = void 0;
          try {
            for ( var u, c = e[ Symbol.iterator ](); !( _n = ( u = c.next() ).done ) && ( r.push( u.value ), !t || r.length !== t ); _n = !0 );
          } catch ( e ) {
            n = !0, o = e
          } finally {
            try {
              _n || null == c.return || c.return()
            } finally {
              if ( n ) throw o
            }
          }
  ...
  563: function ( e, t, r ) {
    ...
    function p( e ) {
      var t = function () {
          ...
          var t = e.index,
            ...
            a = r[ 3 ],
            f = o.length;
          return a ? [ "self-closed", c, t, f ] : u ? [ "closer", c, t, f ] : [ "opener", c, t, f ]
        }(),
        r = Object( i.a )( t, 4 ),
        a = r[ 0 ],
        p = r[ 1 ],
      ...
      switch ( a ) {
        case "no-more-tokens":
          ...
          return b(), !1;
        case "self-closed":
          return 0 === h ? ( null !== v && u.push( n.substr( v, m - v ) ), u.push( e[ p ] ), o = m + O, !0 ) : ( y( d( e[ p ], m, O ) ), o = m + O, !0 );
        case "opener":
          return c.push( d( e[ p ], m, O, m + O, v ) ), o = m + O, !0;
        case "closer":
          if ( 1 === h ) return function ( e ) {
            ...
            d && s.push( d ), null !== o && u.push( n.substr( o, a - o ) ), u.push( l.cloneElement.apply( void 0, [ r, null ].concat( Object( f.a )( s ) ) ) )
          }( m ), o = m + O, !0;
          var S = c.pop(),
            P = n.substr( S.prevOffset, m - S.prevOffset );
          S.children.push( P ), S.prevOffset = m + O;
          var E = d( S.element, S.tokenStart, S.tokenLength, m + O );
          return E.children = S.children, y( E ), o = m + O, !0;
        default:
          return b(), !1
      }
    }
    ...
    var m = function ( e, t ) {
        if ( n = e, o = 0, u = [], c = [], s.lastIndex = 0, ! function ( e ) {
    ...
    function w( e, t ) {
      return e && l.Children.map( e, ( function ( e, r ) {
        if ( Object( v.isString )( e ) ) return Object( l.createElement )( t, {
          key: r
        }, e );
        var n = e.props,
          o = n.children,
          u = Object( h.a )( n, [ "children" ] );
    ...
    var S = r( 124 ),
      P = function ( e ) {
        return !Object( v.isNumber )( e ) && ( Object( v.isString )( e ) || Object( v.isArray )( e ) ? !e.length : !e )
      },
      E = {
        OS: "web",
        select: function ( e ) {
    ...
    var D = Object( l.createContext )( void 0 ),
      A = D.Provider,
      T = D.Consumer,
      _ = Object( l.forwardRef )( ( function () {
        return null
      } ) ),
      R = new Set( [ "string", "boolean", "number" ] ),
      L = new Set( [ "area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr" ] ),
      ...
      N = new Set( [ "autocapitalize", "autocomplete", "charset", "contenteditable", "crossorigin", "decoding", "dir", "draggable", "enctype", "formenctype", "formmethod", "http-equiv", "inputmode", "kind", "method", "preload", "scope", "shape", "spellcheck", "translate", "type", "wrap" ] ),
    ...
    function W( e, t ) {
      switch ( e ) {
        case "style":
          return function ( e ) {
            if ( !Object( v.isPlainObject )( e ) ) return e;
            var t;
            for ( var r in e ) {
              var n = e[ r ];
              if ( null != n ) t ? t += ";" : t = "", t += q( r ) + ":" + G( r, n )
            }
            return t
          }( t )
      }
    ...
    function q( e ) {
      return Object( v.startsWith )( e, "--" ) ? e : z( e, [ "ms", "O", "Moz", "Webkit" ] ) ? "-" + Object( v.kebabCase )( e ) : Object( v.kebabCase )( e )
    }

    function G( e, t ) {
      return "number" != typeof t || 0 === t || $.has( e ) ? t : t + "px"
    }

    function U( e, t ) {
      var r = arguments.length > 2 && void 0 !== arguments[ 2 ] ? arguments[ 2 ] : {};
      if ( null == e || !1 === e ) return "";
      if ( Array.isArray( e ) ) return K( e, t, r );
      switch ( Object( a.a )( e ) ) {
        case "string":
          return Object( k.escapeHTML )( e );
        case "number":
          return e.toString()
      }
      var n = e.type,
      ...
      switch ( n ) {
        case l.StrictMode:
        case l.Fragment:
          return K( o.children, t, r );
        case C:
          var u = o.children,
            c = Object( h.a )( o, [ "children" ] );
          return B( Object( v.isEmpty )( c ) ? null : "div", I( I( {}, c ), {}, {
            dangerouslySetInnerHTML: {
              __html: u
            }
          } ), t, r )
      ...
      switch ( Object( a.a )( n ) ) {
        case "string":
          return B( n, o, t, r );
        case "function":
          return n.prototype && "function" == typeof n.prototype.render ? J( n, o, t, r ) : U( n( o, r ), t, r )
      }
      switch ( n && n.$$typeof ) {
        case A.$$typeof:
          return K( o.children, o.value, r );
        case T.$$typeof:
          return U( o.children( t || n._currentValue ), t, r );
        case _.$$typeof:
          return U( n.render( o ), t, r )
      }
      return ""
    }
    ...
    function B( e, t, r ) {
      var n = arguments.length > 3 && void 0 !== arguments[ 3 ] ? arguments[ 3 ] : {},
        o = "";
      if ( "textarea" === e && t.hasOwnProperty( "value" ) ? ( o = K( t.value, r, n ), t = Object( v.omit )( t, "value" ) ) : t.dangerouslySetInnerHTML && "string" == typeof t.dangerouslySetInnerHTML.__html ? o = t.dangerouslySetInnerHTML.__html : void 0 !== t.children && ( o = K( t.children, r, n ) ), !e ) return o;
      var u = Q( t );
      return L.has( e ) ? "<" + e + u + "/>" : "<" + e + u + ">" + o + "</" + e + ">"
    }
    ...
    function Q( e ) {
      ...
      for ( var r in e ) {
        var n = F( r );
        if ( Object( k.isValidAttributeName )( n ) ) {
          var o = W( r, e[ r ] );
          if ( R.has( Object( a.a )( o ) ) && !V( r ) ) {
            var u = H.has( n );
            if ( !u || !1 !== o ) {
              var c = u || z( r, [ "data-", "aria-" ] ) || N.has( n );
              ( "boolean" != typeof o || c ) && ( t += " " + n, u || ( "string" == typeof o && ( o = Object( k.escapeAttribute )( o ) ), t += '="' + o + '"' ) )
            }
          }
        }
      }
