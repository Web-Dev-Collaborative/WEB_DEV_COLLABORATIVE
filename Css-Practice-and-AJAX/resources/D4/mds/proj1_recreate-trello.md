...
![Trello on a wide screen](images/trello-large-screen.png)

Screenshot of page in medium screen (desktop/tablet) format:

![Trello on a medium screen](images/trello-medium-screen.png)

Screenshot of page in small screen (mobile) format:

![Trello on a small screen](images/trello-small-screen.png)
...
![Trello header nav bar](images/trello-header-navbar.png)
...
![](images/trello-tabbed-navbar.png)
