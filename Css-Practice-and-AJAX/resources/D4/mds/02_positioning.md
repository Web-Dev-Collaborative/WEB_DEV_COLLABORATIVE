...
- [Absolute positioning](#absolute-positioning)
  - [Example of an absolutely positioned element](#example-of-an-absolutely-positioned-element)
  - [Example of two absolutely positioned elements](#example-of-two-absolutely-positioned-elements)
  - [Example of an absolutely positioned element using bottom instead of top](#example-of-an-absolutely-positioned-element-using-bottom-instead-of-top)
...
![Relatively positioned pink box](images/relative-pink-box.png)
...
![Absolutely positioned pink box](images/absolute-pink-box.png)
...
![Two absolutely positioned elements](images/absolute-blue-box.png)
...
![Relative parent and absolute child shifted up](images/relative-parent-absolute-child.png)
...
![](images/static-parent-absolute-child.png)
...
![](images/fixed-element.png)

Here it is with some scrolling.

![](images/fixed-element-scroll.png)
...
![Sticky without scrolling](images/sticky-element.png)

Once you scroll, the element will stick in place when it gets where it should
not scroll past.

![Sticky with scrolling](images/sticky-element-scroll.png)
...
![sticky section headers](images/css-layout-sticky-positioning.gif)
