...
- [AJAX broken down](#ajax-broken-down)
  - [Event listener and Fetch](#event-listener-and-fetch)
  - [PATCH request is made to web server](#patch-request-is-made-to-web-server)
  - [Server sends back a response](#server-sends-back-a-response)
  - [Fetch API receives the response and resolves the promise](#fetch-api-receives-the-response-and-resolves-the-promise)
  - [Response is handled and DOM is updated](#response-is-handled-and-dom-is-updated)
...
![ajax-js-call](images/ajax-js-call.png)
...
![ajax-patch-request](images/ajax-patch-request.png)
...
![ajax-server-response](images/ajax-server-response.png)
...
![ajax-dom-update](images/ajax-dom-update.png)
