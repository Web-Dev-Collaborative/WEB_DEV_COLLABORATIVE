 ...
 * 
 */
( window.dojoWebpackJsonpbundle_client = window.dojoWebpackJsonpbundle_client || [] ).push( [
		...
		33: function ( t, e, n ) {
			...
			t.exports = function () {
				...
				function n( n, i ) {
					...
					for ( var o, s = 2; s < t.length; s++ ) o = t[ s ], r[ o ] = i[ o ] || e[ s ];
					r.buttons = i.buttons || 0;
					var a = 0;
					return a = i.pressure && r.buttons ? i.pressure : r.buttons ? .5 : 0, r.x = r.clientX, r.y = r.clientY, r.pointerId = i.pointerId || 0, r.width = i.width || 0, r.height = i.height || 0, r.pressure = a, r.tiltX = i.tiltX || 0, r.tiltY = i.tiltY || 0, r.pointerType = i.pointerType || "", r.hwTimestamp = i.hwTimestamp || 0, r.isPrimary = i.isPrimary || !1, r
				}
				...
				var o = [ "bubbles", "cancelable", "view", "detail", "screenX", "screenY", "clientX", "clientY", "ctrlKey", "altKey", "shiftKey", "metaKey", "button", "relatedTarget", "buttons", "pointerId", "width", "height", "pressure", "tiltX", "tiltY", "pointerType", "hwTimestamp", "isPrimary", "type", "target", "currentTarget", "which", "pageX", "pageY", "timeStamp" ],
					s = [ !1, !1, null, null, 0, 0, 0, 0, !1, !1, !1, !1, 0, null, 0, 0, 0, 0, 0, 0, 0, "", 0, !1, "", null, null, 0, 0, 0, 0 ],
					a = {
						pointerover: 1,
						pointerout: 1,
						pointerenter: 1,
					...
					c = {
						...
						cloneEvent: function ( t ) {
							for ( var e, n = Object.create( null ), i = 0; i < o.length; i++ ) n[ e = o[ i ] ] = t[ e ] || s[ i ], !u || "target" !== e && "relatedTarget" !== e || n[ e ] instanceof SVGElementInstance && ( n[ e ] = n[ e ].correspondingUseElement );
						...
						propagate: function ( t, e, n ) {
							for ( var i = t.target, r = []; !i.contains( t.relatedTarget ) && i !== document; ) r.push( i ), i = i.parentNode;
						...
						setCapture: function ( t, e ) {
							...
							i.pointerId = t, this.implicitRelease = this.releaseCapture.bind( this, t ), document.addEventListener( "pointerup", this.implicitRelease ), document.addEventListener( "pointercancel", this.implicitRelease ), i._target = e, this.asyncDispatchEvent( i )
						},
						releaseCapture: function ( t ) {
							var e = this.captureInfo[ t ];
							if ( e ) {
								var i = new n( "lostpointercapture" );
								i.pointerId = t, this.captureInfo[ t ] = void 0, document.removeEventListener( "pointerup", this.implicitRelease ), document.removeEventListener( "pointercancel", this.implicitRelease ), i._target = e, this.asyncDispatchEvent( i )
							}
						},
				...
				function E( t, e, n, i ) {
					this.addCallback = t.bind( i ), this.removeCallback = e.bind( i ), this.changedCallback = n.bind( i ), f && ( this.observer = new f( this.mutationWatcher.bind( this ) ) )
				}
				...
				var R, C = {
						...
						mousedown: function ( t ) {
							if ( !this.isEventSimulatedFromTouch( t ) ) {
								var e = O.get( this.POINTER_ID ),
									n = this.prepareEvent( t );
								M || ( n.buttons = I[ n.button ], e && ( n.buttons |= e.buttons ), t.buttons = n.buttons ), O.set( this.POINTER_ID, t ), e && 0 !== e.buttons ? c.move( n ) : c.down( n )
							}
						},
						mousemove: function ( t ) {
							if ( !this.isEventSimulatedFromTouch( t ) ) {
								var e = this.prepareEvent( t );
								M || this.prepareButtonsForMove( e, t ), e.button = -1, O.set( this.POINTER_ID, t ), c.move( e )
							}
						},
						mouseup: function ( t ) {
							if ( !this.isEventSimulatedFromTouch( t ) ) {
								...
								O.set( this.POINTER_ID, t ), n.buttons &= ~I[ n.button ], 0 === n.buttons ? c.up( n ) : c.move( n )
							}
						},
						mouseover: function ( t ) {
							if ( !this.isEventSimulatedFromTouch( t ) ) {
								var e = this.prepareEvent( t );
								M || this.prepareButtonsForMove( e, t ), e.button = -1, O.set( this.POINTER_ID, t ), c.enterOver( e )
							}
						},
						mouseout: function ( t ) {
							if ( !this.isEventSimulatedFromTouch( t ) ) {
								var e = this.prepareEvent( t );
								M || this.prepareButtonsForMove( e, t ), e.button = -1, c.leaveOut( e )
							}
						},
						cancel: function ( t ) {
							var e = this.prepareEvent( t );
					...
					L = {
						...
						elementAdded: function ( t ) {
							...
							n && ( t._scrollType = n, c.listen( t, this.events ), D( t ).forEach( function ( t ) {
								t._scrollType = n, c.listen( t, this.events )
							}, this ) )
						},
						elementRemoved: function ( t ) {
							t._scrollType = void 0, c.unlisten( t, this.events ), D( t ).forEach( function ( t ) {
						...
						elementChanged: function ( t, e ) {
							...
							i && r ? ( t._scrollType = i, D( t ).forEach( function ( t ) {
								t._scrollType = i
						...
						setPrimaryTouch: function ( t ) {
							( 0 === N.size || 1 === N.size && N.has( 1 ) ) && ( this.firstTouch = t.identifier, this.firstXY = {
								X: t.clientX,
								Y: t.clientY
						...
						moveOverOut: function ( t ) {
							...
							if ( n ) {
								var i = n.out,
									r = n.outTarget;
								c.move( e ), i && r !== e.target && ( i.relatedTarget = e.target, e.relatedTarget = r, i.target = r, e.target ? ( c.leaveOut( i ), c.enterOver( e ) ) : ( e.target = r, e.relatedTarget = null, this.cancelOut( e ) ) ), n.out = e, n.outTarget = e.target
							}
						},
						touchend: function ( t ) {
						...
						upOut: function ( t ) {
							this.scrolling || ( c.up( t ), c.leaveOut( t ) ), this.cleanUpPointer( t )
						},
						...
						cleanUpPointer: function ( t ) {
							N.delete( t.pointerId ), this.removePrimaryPointer( t )
						},
				...
				R = new E( L.elementAdded, L.elementRemoved, L.elementChanged, L );
				var X, k, A = c.pointermap,
					F = window.MSPointerEvent && "number" == typeof window.MSPointerEvent.MSPOINTER_TYPE_MOUSE,
					K = {
						...
						prepareEvent: function ( t ) {
							var e = t;
							return F && ( ( e = c.cloneEvent( t ) ).pointerType = this.POINTER_TYPES[ t.pointerType ] ), e
						},
						cleanup: function ( t ) {
							A.delete( t )
						},
				...
				return window.navigator.msPointerEnabled ? ( X = function ( t ) {
						x( t ), j( this ), B( t ) && this.msSetPointerCapture( t )
					}, k = function ( t ) {
						x( t ), this.msReleasePointerCapture( t )
					} ) : ( X = function ( t ) {
						x( t ), j( this ), B( t ) && c.setCapture( t, this )
					}, k = function ( t ) {
						x( t ), c.releaseCapture( t, this )
					} ),
					function () {
						if ( P ) {
							y.forEach( function ( t ) {
								String( t ) === t ? ( w += T( t ) + g( t ) + "\n", S && ( w += b( t ) + g( t ) + "\n" ) ) : ( w += t.selectors.map( T ) + g( t.rule ) + "\n", S && ( w += t.selectors.map( b ) + g( t.rule ) + "\n" ) )
							} );
					...
					function () {
						if ( !window.PointerEvent ) {
							if ( window.PointerEvent = n, window.navigator.msPointerEnabled ) {
								var t = window.navigator.msMaxTouchPoints;
								Object.defineProperty( window.navigator, "maxTouchPoints", {
									value: t,
									enumerable: !0
								} ), c.registerSource( "ms", K )
							} else c.registerSource( "mouse", C ), void 0 !== window.ontouchstart && c.registerSource( "touch", L );
							c.register( document )
						}
...
//# sourceMappingURL=pointerEvents.ba03a24b846627391b36.bundle.js.map
